...
- (void)viewDidLoad {
    ...
    [self createAddTypeNavigationBarWithLeftTitle:[NSString stringWithFormat:@"%ld年流水",[NSDate getCurrentDateWithType:DateTypeYear]] leftAction:@selector(backBtnClick) rightAction:@selector(writeBtnClick)];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.transcationArray = [TranscationTableDAO getTranscationsWithTimestamp:[NSDate getTimestampWithType:DateTypeYear] accountBookID:[MoneySingleton sharedMoneySingleton].defaultAccountBookID];
...
{
    Summary *summary = [TranscationTableDAO getSummaryWithTimestamp:DateTypeYear accountBookID:[MoneySingleton sharedMoneySingleton].defaultAccountBookID];
